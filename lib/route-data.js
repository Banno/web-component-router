...
class RouteData {
   ...
   * @param {BeforeEnter=} beforeEnter Function to execute before the route is entered.
   * @param {RouteEnter=} routeEnter Function to execute when the route is entered.
   * @param {RouteExit=} routeExit Function to execute when the route is exited.
   */
