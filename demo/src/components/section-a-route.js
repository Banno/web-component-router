...
class SectionARoute extends routingMixin(LitElement) {
  ...
  render() {
    return html`
      ...
      <p>
        This section has its own subRoute, which are loaded in
        <code>slot</code> below.
      </p>
      ...
      <ul>
        <li>
          <a href="/section-a/test-param"
            >Section A1 with sectionAId: test-param</a
          >
        </li>
        <li>
          <a href="/section-a/cheese">Section A1 with sectionAId: cheese</a>
        </li>
      </ul>
